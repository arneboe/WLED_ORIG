...
WLED_GLOBAL byte apBehavior _INIT(AP_BEHAVIOR_BUTTON_ONLY);       // access point opens when no connection after boot by default
...
WLED_GLOBAL bool fadeTransition      _INIT(false);   // enable crossfading color transition
